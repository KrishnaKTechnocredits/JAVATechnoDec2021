...
class A11_String_Operation {
	...
	public static void main(String[] args) {
		...
		A11_String_Operation str = new A11_String_Operation();
		
		int firstOccIndex = str.getFirstOccurenceOfChar("Kalyani Jalekar", 'z');
		if (firstOccIndex == -1)
		...
		int lastOccIndex = str.getLastOccurenceOfChar("Kalyani Jalekar", 'a');
		if (lastOccIndex == -1)
		...
		boolean presenceOFChar = str.isCharPresent("Kalyani Jalekar", 'a');
		System.out.println("Check Presence of character true/false :  " + presenceOFChar);
		
		int totalCount = str.getOccurenceOfChar("Kalyani Jalekar", 'a');
