...
public class Ass27 {
	...
	public static void main(String[] args) {
		Ass27 ass = new Ass27();
		ass.findValidOrInvalidPhoneNumPattern("+91 9765463742");
		System.out.println();
		ass.findValidOrInvalidPhoneNumPattern("976 546 37 42");
		System.out.println();
		ass.findValidOrInvalidPhoneNumPattern("09765463742");
		System.out.println();
		ass.findValidOrInvalidPhoneNumPattern("9765463742");
		System.out.println();
		ass.findValidOrInvalidPhoneNumPattern("AD 9765 36 25");
		System.out.println();
		ass.findValidOrInvalidPhoneNumPattern("6765262523");
	}
