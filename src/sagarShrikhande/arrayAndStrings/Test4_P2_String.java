...
public class Test4_P2_String {
	...
	public static void main(String[] args) {
		...
		Test4_P2_String test4_P2_String = new Test4_P2_String();
		System.out.println(test4_P2_String.wordWithPrimeNumLength(input1));
		System.out.println(test4_P2_String.wordWithPrimeNumLength(input2));
	}
}
