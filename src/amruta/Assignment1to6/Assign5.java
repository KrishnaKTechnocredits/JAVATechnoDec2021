...
public class Assign5 {
	...
	public static void main(String[] args) {
		...
		assign5.printEvenNum(10, 15);
		assign5.printNumDivisibleby5(10, 30);
		assign5.printNumdivisiblebyThreeandFive(5, 18);
		assign5.printNumdivisibleby7and13(5, 40);
		assign5.sumOfAllnum(1, 5);
		assign5.sumOfEvenOdd(3, 9);
		assign5.printOddnumber(20, 10);
	}
