...
public class Assignment24 {
	...
	public static void main(String[] args) {
		...
		assignment24.findTotalWordsInStringWithLength("Hi Hello");
		System.out.println();
		System.out.println("Output of Program 2: ");
		assignment24.findTotalVowelsInEachWordsInString("Aashvi Technocredits");
		System.out.println();
		System.out.println("Output of Program 3: ");
		String[] arr = assignment24.arrayOFWordsContainingDigits("ATe1c2h C94re3");
		System.out.println(Arrays.toString(arr));
		System.out.println();
		System.out.println("Output of Program 4: ");
		String[] revArr = assignment24.reverseOFWordsInSamePosition("Hi Techno Hello");
		System.out.println(Arrays.toString(revArr));
		System.out.println();
		System.out.println("Output of Program 5: ");
		String[] convertFirstLetterofWordsArr = assignment24.convertFirstLetterOFWordsToUpperCase("anvit harsh dipali");
		System.out.println(Arrays.toString(convertFirstLetterofWordsArr));
		System.out.println();
		System.out.println("Output of Program 6: ");
		String[] convertFirstLetterofRevWordsArr = assignment24
		...
		assignment24.swapCasesOfWords("TeCHnoCReditS");
	}
