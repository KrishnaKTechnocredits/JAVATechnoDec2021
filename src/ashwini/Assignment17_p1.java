...
public class Assignment17_p1 {
	void findConsecutiveNumber(int[] num) {
		for (int index = 0; index < num.length - 2; index++) {
			if (num[index] + 1 == num[index + 1] && num[index] + 2 == num[index + 2]) {
				System.out.println("The consecutive numbers are : " + num[index] + " --> " + num[index + 1] + " --> "
						+ num[index + 2]);
			}
		}
	}
	...
	public static void main(String[] arr) {
		...
		Assignment17_p1 a17_consecutiveNum = new Assignment17_p1();
