...
public class A29_TotalSumOfAllTheNumbersInTheString {
	...
	public static void main(String[] args) {
		A29_TotalSumOfAllTheNumbersInTheString a29 = new A29_TotalSumOfAllTheNumbersInTheString();
		String str = "I have 15 years and 3 months of automation experience";
		System.out.println(str);
		a29.sumOfNumbers(str);
