...
public class A10_PrimeNumber {
	...
	void totalPrimeNumbersInRange(int startNum, int lastNum) {
		count = 0;
	...
	void averageOfAllPrimeNumberInRange(int startNum, int lastNum) {
		...
		findPrimeNumberInRange(startNum, lastNum);
		average = (double) sum/count;
		System.out.println("Average of Prime numbers between "+startNum+" and "+lastNum+" is : " + average);
	}
	...
	public static void main(String [] args) {
		...
		System.out.println();
		primeNumber.totalPrimeNumbersInRange(1, 10);
		System.out.println();
